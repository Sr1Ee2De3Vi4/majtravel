...
class signup extends Component {
   ...
   <div  class=" uk-align-center  " style={{paddingLeft:"20%",paddingRight:"20%"}}>
            ...
            <div>
                <svg xmlns="http://www.w3.org/2000/svg"  id="account" style={{height:"25px",width:"25px",zoom:"250%",marginBottom:"2%",color:"blueviolet",borderColor:"black"}}>
                <path fill="#1877F2" d="M21 22h-2v-3a3 3 0 00-3-3 3 3 0 01-2.99-2.84l-.03-.6.53-.32A2.97 2.97 0 0015 9.67V7a3 3 0 00-6 0v2.67c0 1.06.56 2.02 1.5 2.57l.52.31-.03.6A3 3 0 018 16a3 3 0 00-3 3v3H3v-3a5 5 0 015-5 1 1 0 00.85-.48A5 5 0 017 9.67V7a5 5 0 0110 0v2.67a5 5 0 01-1.85 3.85A1 1 0 0016 14a5 5 0 015 5v3z"></path></svg>
                    ...
                    <div class="s1" style={{height:"90px"}}>
                        Get started.
                    ...
                    <div>
                        ...
                        <button class="uk-button button22">Continue with email</button>
                    </div>
            
                      <div class="" style={{color:"blue"}}>
                        <p class="t4">Already have an account?&nbsp;
                        <span class="uk-link-reset t32 uk-text-primary" ><a href="/login">Sign in</a></span>
                        </p>
            ...
            {/* ------------------------------------------------------------------------ */}
                <p class="uk-heading-line uk-text-center t12"><span>&nbsp; OR &nbsp;</span></p>
                ...
                <button class="uk-button uk-button-default  uk-width-1-1 uk-child-width-1-2 uk-grid uk-remove-padding button12" href="#">
                    
                    <div class="uk-width-4-5  " style={{paddingLeft:"20px"}}>
                    <p class="uk-margin-remove uk-align-left " style={{fontSize:"18px"}} >Continue with Google   </p>
                    </div>
                ...
                <button class="uk-button uk-button-default  uk-width-1-1 uk-child-width-1-2 uk-grid uk-remove-padding button12" href="#">
                    ...
                    <div class="uk-width-4-5  " style={{paddingLeft:"20px"}}>
                    <p class="uk-margin-remove uk-align-left " style={{fontSize:"18px"}} >  Continue with Facebook  </p>
                    </div>
                    <div class="uk-width-1-5 uk-padding-remove-left"  style={{}}>
     ...
     <p class="s32" style={{lineHeight:"1px"}}>By continuing, you agree to HMD Global's &nbsp;
